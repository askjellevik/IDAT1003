...
public class Task1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            int inpEmployeeChoice = scanner.nextInt();
            for (Employee employee : employeeList) {
                if (inpEmployeeChoice == employee.getEmployeeNr()) {
            ...
            while (runCode) {
                if (menuDisplayVariable == 0) {
                    ...
                    if (inpChoice == 1) {
                        ...
                        int newTaxPercentage = scanner.nextInt();
    ...
    public static void showMainMenu() {
        System.out.println("Welcome to the Employee program. Enter the number corresponding to your choice: ");
    ...
    public static void showDisplayOptions() {
        ...
        System.out.println("7: Check if the employee has worked for more than a giving amount of years");
